Feature: Domain.Serialisation
  ...
  Scenario: Serialising a Model.Read.Adventure
    Given the serialisation {"Player":{"name":"Mrs. Hollywookle","state":[{"Item1":{"typeName":"GoodNight.Service.Domain.Model.Read.Quality, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"qualrefef"},"Item2":{"type":"int","iValue":10}}]},"User":"00000000-0000-0000-0000-000000000000","Story":{"typeName":"GoodNight.Service.Domain.Model.Read.Story, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"eine-neue-geschichte-"},"History":[],"Current":{"Scene":{"typeName":"GoodNight.Service.Domain.Model.Read.Scene, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"eine-neue-geschichte-/start"},"Text":"This is where the story starts.","Effects":[],"Options":[{"Urlname":"pfad1/5","Text":"hier ist option fuer Pfad 1.\n\nmal sehen, ob der Abs\u00E4tze kann.","Icon":"","IsAvailable":true,"Requirements":[],"Effects":[],"Scene":{"typeName":"GoodNight.Service.Domain.Model.Read.Scene, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"eine-neue-geschichte-/pfad1"}},{"Urlname":"barboza/6","Text":"Oder sonst auch Barboza. Was auch immer.","Icon":"","IsAvailable":true,"Requirements":[],"Effects":[],"Scene":{"typeName":"GoodNight.Service.Domain.Model.Read.Scene, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"eine-neue-geschichte-/barboza"}}]},"Key":"00000000-0000-0000-0000-000000000000/eine-neue-geschichte-"}
    Given the type "GoodNight.Service.Domain.Model.Read.Adventure, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
    When deserialising and serialising
    Then the new serialisation equals given input

  Scenario: Serialising a Model.Read.Player
    Given the serialisation {"name":"playerayer","state":[{"Item1":{"typeName":"GoodNight.Service.Domain.Model.Read.Quality, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","key":"qualrefef"},"Item2":{"type":"int","iValue":10}}]}
    Given the type "GoodNight.Service.Domain.Model.Read.Player, GoodNight.Service.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
    When deserialising and serialising
    Then the new serialisation equals given input
